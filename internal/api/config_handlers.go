...
func (s *Server) handlePatchConfigSection(c *fiber.Ctx) error {
	...
	case "server", "api", "auth", "database", "metadata", "streaming", "transcoding", "health", "import", "log", "sabnzbd", "arrs", "segment_cache", "system", "stremio", "local_media", "tube_tv", "tater_bumpers":
		err = c.BodyParser(newConfig)
