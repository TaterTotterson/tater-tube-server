...
func (s *Server) SetupRoutes(app *fiber.App) {
	...
	api.Post("/v1/player/capabilities", s.handleTaterPlayerCapabilities)
	...
	api.Get("/v1/player/artwork/channel-logo", s.handleTaterTVChannelLogo)
	...
	api.Post("/tater/core/recommendations", s.handleTaterCoreSaveRecommendations)
	api.Get("/tater/core/tts/requests", s.handleTaterCoreClaimTTSRequests)
	api.Post("/tater/core/tts/requests/:id/complete", s.handleTaterCoreCompleteTTSRequest)
	api.Post("/tater/viewing/events", s.handleTaterSaveViewingEvent)
	api.Get("/tater/recommendations", s.handleTaterPlayerRecommendations)
	api.Post("/tater/recommendations/:id/feedback", s.handleTaterRecommendationFeedback)
	api.Post("/tater/tts/requests", s.handleTaterPlayerCreateTTSRequest)
	api.Get("/tater/tts/requests/:id", s.handleTaterPlayerTTSRequest)
	api.Get("/tater/tts/requests/:id/audio", s.handleTaterPlayerTTSAudio)
	api.Delete("/tater/tts/requests/:id", s.handleTaterPlayerCancelTTSRequest)
	...
	api.Get("/tater/music/artwork", s.handleTaterMusicArtwork)
	...
	api.Get("/tater/core/admin", s.handleTaterAdminState)
	api.Post("/tater/core/codes", s.handleTaterCreateCorePairingCode)
	api.Delete("/tater/core/connections/:id", s.handleTaterRevokeCore)
	api.Delete("/tater/viewing/history", s.handleTaterClearViewingHistory)
	...
	api.Get("/local-media/library", s.handleLocalMediaLibrary)
	api.Get("/local-media/scan", s.handleLocalMediaScanStatus)
	api.Post("/local-media/scan", s.handleLocalMediaScan)
	api.Get("/local-media/music/artwork", s.handleLocalMediaMusicArtwork)
	api.Post("/local-media/music/artwork/refresh", s.handleLocalMediaMusicArtworkRefresh)
