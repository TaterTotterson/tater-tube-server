		...
		<div className="space-y-10">
			<div>
				...
				<p className="text-base-content/50 text-sm">
					Detect FFmpeg and hardware acceleration for Tater Tube players that request
					transcoding.
				</p>
			</div>
			...
			<div className="space-y-8">
				...
				<div className="fade-in slide-in-from-top-2 grid animate-in gap-6 rounded-2xl border-2 border-base-300/80 bg-base-200/60 p-6 md:grid-cols-2">
					...
					<label className="form-control">
						<span className="label-text font-bold text-base-content text-sm">Hardware Device</span>
						<input
							type="text"
							className="input input-bordered mt-2 w-full"
				...
				<div className="fade-in slide-in-from-top-2 alert animate-in items-start rounded-2xl border border-info/20 bg-info/5 p-4 shadow-sm">
					...
					<div className="min-w-0 flex-1">
						...
						<div className="mt-1 break-words text-[11px] leading-relaxed opacity-80">
							The server does not globally enable or disable transcoding. Tater Tube players
							request direct play or FFmpeg transcoding per playback request.
						</div>
					</div>
				</div>
			</div>
